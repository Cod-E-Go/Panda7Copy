...
/*
 *	jQuery brandCarousel v1.23
 *
 *	Copyright (c) 2013 Bartosz Wojciechowski
 *	http://www.owlgraphic.com/brandCarousel/
 *
 *	Licensed under MIT
 *
 */
...
(function( $, window, document, undefined ) {
	...
	var Carousel = {
		init :function(options, el){
			var base = this;
			base.options = base.userOptions = $.extend({}, $.fn.brandCarousel.options, options);
			var elem = el;
			var $elem = $(el);
			base.$elem = $elem;
			base.loadContent();
	...
	$.fn.brandCarousel = function( options ){
		return this.each(function() {
			...
			$.data( this, "brandCarousel", carousel );
		});
	};

	$.fn.brandCarousel.options = {
